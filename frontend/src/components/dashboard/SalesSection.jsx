        ...
        <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {top.map((u, i) => (
            <div key={u.userId ?? u.id ?? i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: '#334155', display: u.avatarUrl ? 'none' : 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: '#e2e8f0' }}>
                {initials(u)}
              </div>
