...
class _LearningPathsPageState extends State<LearningPathsPage> {
  ...
  Future<void> _loadPaths() async {
    ...
    try {
      final result = await LearningPathService.getPublishedPaths(
        languageId: widget.selectedLanguageId,
        size: 20,
      );
    ...
    return Scaffold(
      ...
      body: isLoading
        ...
        child: Padding(
          ...
          child: Text(
            widget.selectedLanguageId != null
                ? "Chưa có learning path nào cho ngôn ngữ bạn đã chọn"
